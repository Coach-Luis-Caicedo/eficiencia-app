...
subproceso desde el arnes JS (motor-integracion-iao-aie/pipeline.js).

Copia byte-identica del puente ya usado en
motor-integracion-sdmo-aie/run_case_bridge.py (685d140) - mismo criterio:
una sola fuente de verdad para las reglas AIE, sin reimplementar nada.
